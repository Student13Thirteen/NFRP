...
import { deleteMaintenanceSupplierAction, updateMaintenanceSupplierAction } from '../../../actions';

type MaintenanceSupplierDetailPageProps = {
  params: Promise<{ id: string }>;
  searchParams: Promise<{ error?: string }>;
};

export default async function MaintenanceSupplierDetailPage({ params, searchParams }: MaintenanceSupplierDetailPageProps) {
  await requireUser();
  ...
  return (
    <>
      ...
      <section className="panel">
        ...
        <form action={updateMaintenanceSupplierAction.bind(null, supplier.id)} className="form-stack">
        ...
        <div className="record-actions">
          <form action={deleteMaintenanceSupplierAction.bind(null, supplier.id)}>
            <ConfirmSubmitButton
