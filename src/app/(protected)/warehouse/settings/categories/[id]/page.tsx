...
import { deleteWarehouseCategoryAction, updateWarehouseCategoryAction } from '../../../actions';

type WarehouseCategoryDetailPageProps = {
  params: Promise<{ id: string }>;
  searchParams: Promise<{ error?: string }>;
};

export default async function WarehouseCategoryDetailPage({ params, searchParams }: WarehouseCategoryDetailPageProps) {
  await requireUser();
  ...
  return (
    <>
      ...
      <section className="panel">
        ...
        <form action={updateWarehouseCategoryAction.bind(null, category.id)} className="form-stack">
          <label>
            Nome categoria
        ...
        <div className="record-actions">
          <form action={deleteWarehouseCategoryAction.bind(null, category.id)}>
            <ConfirmSubmitButton
